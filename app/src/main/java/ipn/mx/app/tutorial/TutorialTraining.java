...
public class TutorialTraining extends AppCompatActivity implements View.OnClickListener {

    VideoView videoView;
    TextView fullscreen;
    View arrow;

    final String urlTutorialHeadset = "https://youtu.be/0jL8kW_jpyI";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.tutorial_entrenamiento);
